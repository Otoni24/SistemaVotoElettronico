...
public class resCatPrefController {
    @FXML
    ...
    public void resElection(elezione.id) {
        for(int i=0;i<NumeroCandidati;i++) {
            Label lb = new Label(elezione.prefcandidati[i] + elezione.votoperprefcandidato[i]); //meglio fare una mappa e sortarla decrescentemente in base ai voti
            lb.setLayoutX(0);
            lb.setLayoutY(i*100);
            prefVBox.getChildren().add(lb);
        }
    }*/
